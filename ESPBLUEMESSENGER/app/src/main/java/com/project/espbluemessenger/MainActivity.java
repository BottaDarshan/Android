package com.project.espbluemessenger;
...
public class MainActivity extends AppCompatActivity {
    ...
    static final UUID MY_UUID = UUID.fromString("b351eb9d-96a1-4a67-bde2-4cb6676d46fa");
...
//                                bBTConnected = false;
    ...
    void readAllData() {
        ...
        try {
            ...
            sM1Index = spSavedBluetoothDevice.getString("M1_INDEX", null);
            sM1Data = spSavedBluetoothDevice.getString("M1_DATA", null);
            sM2Index = spSavedBluetoothDevice.getString("M2_INDEX", null);
            sM2Data = spSavedBluetoothDevice.getString("M2_DATA", null);
            sM3Index = spSavedBluetoothDevice.getString("M3_INDEX", null);
            sM3Data = spSavedBluetoothDevice.getString("M3_DATA", null);
            sM4Index = spSavedBluetoothDevice.getString("M4_INDEX", null);
            sM4Data = spSavedBluetoothDevice.getString("M4_DATA", null);
            sM5Index = spSavedBluetoothDevice.getString("M5_INDEX", null);
            sM5Data = spSavedBluetoothDevice.getString("M5_DATA", null);
            sM6Index = spSavedBluetoothDevice.getString("M6_INDEX", null);
            sM6Data = spSavedBluetoothDevice.getString("M6_DATA", null);
            sM7Index = spSavedBluetoothDevice.getString("M7_INDEX", null);
            sM7Data = spSavedBluetoothDevice.getString("M7_DATA", null);
            sM8Index = spSavedBluetoothDevice.getString("M8_INDEX", null);
            sM8Data = spSavedBluetoothDevice.getString("M8_DATA", null);
    ...
    void populateSpinnerWithBTPairedDevices() {
        ...
        if (BTPairedDevices != null) { // Check for null before iterating
            for (BluetoothDevice BTDev : BTPairedDevices) {
                if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
        ...
        ArrayAdapter<String> aaPairedDevices = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, alPairedDevices);
